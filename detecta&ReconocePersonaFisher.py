#programa para detectar y reconocer rostros para su ingreso a un laboratorio Fisher
import time
import cv2
...
face_recognizer.read("/home/rf/Documentos/xmlrostros/modeloFisherFace503All.xml")
